...
export default function LoginPage() {
 ...
 <CardDescription className=" text-muted-foreground">Masuk ke akun Anda</CardDescription>
 </CardHeader>
 ...
 <Link href="/register" className="font-medium text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 transition-colors">
 Daftar sekarang
 </Link>
 </CardFooter>
 </Card>
